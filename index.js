...
var ASM_CONSTS = {
 ...
 170167: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 170250: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 170319: () => { return window.innerWidth; },  
 170349: () => { return window.innerHeight; }
};
